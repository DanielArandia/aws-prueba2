...
app = Flask(__name__)  # Cambié _name_ a __name__
...
if __name__ == '__main__':  # Cambié _name_ a __name__ y _main_ a __main__
    app.run(debug=True, host='0.0.0.0')  # Reemplacé el espacio no separable por un espacio regular